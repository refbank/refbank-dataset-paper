...
Refbank currently has data from 12 datasets (11 English, 1 Dutch), including 1.3 million words from 126K referential trials from 2390 games and 4770 participants (Table 1). 7~datasets were online experiments where participants typed written messages, and 5 datasets were in-person experiments where participants spoke face-to-face. Studies varied in participant population, group size or partner switching structure, type and number of targets, and type of backchannel permitted. We are currently adding 6 more datasets with spoken interaction (4 English, 1 Swiss German, 1 French), comprising 10,000 trials (150 games).
