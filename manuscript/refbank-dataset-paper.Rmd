...
acc ~ rep_num + (rep_num | paper / condition) -- logistic

log rt ~ rep_num + (rep_num | paper / condition) -- linear? or log log?
...
definites --discussion point how to group the different categories!


pos --discussion point how to group the different categories!
